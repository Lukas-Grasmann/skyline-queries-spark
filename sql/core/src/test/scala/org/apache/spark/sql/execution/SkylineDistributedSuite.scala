...
class SkylineDistributedSuite extends SparkPlanTest with SharedSparkSession {
  import testImplicits.{localSeqToDatasetHolder, newProductEncoder}

  test("basic min skyline using distributed complete algorithm") {
    val input = Seq(
      ("A", 1, 2.0),
      ("B", 3, 4.0),
      ("C", 4, 3.0)
  ...
  test("basic max skyline using distributed complete algorithm") {
    val input = Seq(
      ("A", 1, 2.0),
      ("B", 3, 4.0),
      ("C", 4, 3.0)
  ...
  test("basic diff skyline using distributed complete algorithm") {
    val input = Seq(
      ("A", 1, 2.0, 1),
      ("B", 3, 4.0, 2),
      ("C", 4, 3.0, 3)
  ...
  test("non-distinct skyline using distributed complete algorithm") {
    val input = Seq(
      ("A", 1, 2.0),
      ("B", 1, 2.0),
      ("C", 4, 3.0)
  ...
  test("distinct skyline using distributed complete algorithm") {
    val input = Seq(
      ("A", 1, 2.0),
      ("B", 1, 2.0),
      ("C", 4, 3.0)
